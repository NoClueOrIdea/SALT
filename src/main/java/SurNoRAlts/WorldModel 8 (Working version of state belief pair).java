	...
	*/
	...
	public void updateBelief(int cstate,int selected_action,int sprime)
	{
		...
		*/
		...
		{
			int given_NFR = NFR[sprime][sat_NFR%3];
			if(((given_NFR==1)&&(sat_NFR<3)) | (((given_NFR==0) && (sat_NFR>2))))
			{
			...
			alpha[cstate][selected_action][cnfr]=((1-adaptation_rate)*alpha[cstate][selected_action][sat_NFR])+(adaptation_rate*alpha_t1[cstate][selected_action][sat_NFR])+kroneckers_delta;
